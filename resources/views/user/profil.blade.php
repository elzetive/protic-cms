...
@section('content')
    ...
    {{-- SECTION: OUR TEAM (DINAMIS DENGAN MAPPING GAMBAR SESUAI FOTO MENU) --}}
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                @foreach($listDivisi as $div)
                    @php
                        ...
                        // 1. Bersihkan nama untuk mencari file gambar (Hapus "DIVISI ", hapus "/")
                        $cleanName = str_replace(['DIVISI ', '/'], '', $namaDivisi);
                        $fileName = strtolower(trim($cleanName)) . '.jpg';

                        // 2. Handle khusus jika namanya BPH
