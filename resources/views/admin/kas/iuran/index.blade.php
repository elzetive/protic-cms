...
<div class="space-y-6 animate-in fade-in duration-500">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-black text-[#0a362d] uppercase tracking-widest">Manajemen Iuran</h1>
        <a href="{{ route('admin.iuran.tambah') }}" class="bg-[#0a362d] text-white px-5 py-2.5 rounded-xl text-xs font-bold flex items-center gap-2 hover:bg-[#082a23] transition-all shadow-lg shadow-[#0a362d]/20 active:scale-95">
            <i class="fa-solid fa-plus text-[10px]"></i> TAMBAH IURAN
        </a>
    </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/80 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-100">
                        ...
                        <th class="px-8 py-5">Progress Bayar</th>
                        <th class="px-8 py-5">Total Terkumpul</th>
                        <th class="px-8 py-5 text-center">Status</th>
                        <th class="px-8 py-5 text-center">Aksi</th>
                    </tr>
                </thead>
                <tbody class="text-[11px] font-bold text-[#0a362d] divide-y divide-gray-50">
                    {{-- LIMIT DATA: Dikurangi 1 jadi 6 Baris --}}
                    @for ($i = 0; $i < 6; $i++)
                    <tr class="hover:bg-gray-50/30 transition-colors group">
                        <td class="px-8 py-4 uppercase tracking-tighter">
                            <span class="text-gray-400 font-medium italic">Mei</span> 2026
                        </td>
                        <td class="px-8 py-4">
                            <div class="flex flex-col gap-1.5 w-32">
                                <span class="text-[9px] uppercase tracking-widest text-gray-400">20/55 Anggota</span>
                                <div class="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden">
                                    <div class="bg-amber-500 h-full rounded-full shadow-[0_0_8px_rgba(245,158,11,0.3)]" style="width: 40%"></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="tracking-wider">250.000</span>
                            </div>
                        </td>
                        <td class="px-8 py-4 text-center">
                            ...
                            @else
                                <span class="bg-amber-50 text-amber-600 px-3 py-1 rounded-full text-[8px] uppercase tracking-widest font-black">Proses</span>
                            @endif
                        </td>
                        <td class="px-8 py-4 text-center">
                            <div class="flex items-center justify-center gap-4">
                                <a href="{{ route('admin.iuran.detail') }}" class="text-gray-300 hover:text-[#0a362d] transition-colors text-[10px] uppercase tracking-tighter">Detail</a>
